...
curl_setopt($curl, CURLOPT_URL, 'https://api.nasa.gov/planetary/apod?api_key=auxmY8ER4AzyubdprEyUSq6J1W0sPsdUalSGDljZ&date=2021-12-25');
$res = curl_exec($curl);
...
print("<br>");
print("<img src=https://apod.nasa.gov/apod/image/2112/C2021A1_211221_1024.jpg>");
print("<br>");

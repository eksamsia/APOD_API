...
curl_setopt($curl, CURLOPT_URL, 'https://api.nasa.gov/planetary/apod?api_key=auxmY8ER4AzyubdprEyUSq6J1W0sPsdUalSGDljZ&date=2021-03-27');
$res = curl_exec($curl);
...
print("<br>");
print("<img src=https://apod.nasa.gov/apod/image/2103/C60-61_PS2_CROP_FULL1024.jpg>");
print("<br>");

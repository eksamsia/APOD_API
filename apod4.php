...
curl_setopt($curl, CURLOPT_URL, 'https://api.nasa.gov/planetary/apod?api_key=auxmY8ER4AzyubdprEyUSq6J1W0sPsdUalSGDljZ&date=2021-02-14');
$res = curl_exec($curl);
...
print("<br>");
print("<img src=https://apod.nasa.gov/apod/image/2102/rosette_BlockPuckett_960.jpg>");
print("<br>");
